<nav class="navbar roboto navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="panel.php"><i class="fas fa-home"></i> Inicio</a>
                </li>
                <li class="nav-item">
            ...
            <div class="d-flex">
                <li class="navbar-nav nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li><a class="dropdown-item" href="#"><i class="fas fa-tools"></i> Configuración</a></li>
                        <li>
